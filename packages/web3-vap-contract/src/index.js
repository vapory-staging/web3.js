...
Contract.prototype.deploy = function(options, callback){
    ...
    return this._createTxObject.apply({
        ...
        _vapAccounts: this.constructor._vapAccounts
    }, options.arguments);
...
Contract.prototype._createTxObject =  function _createTxObject(){
    ...
    txObject._vapAccounts = this.parent.constructor._vapAccounts || this._vapAccounts;
...
Contract.prototype._executeMethod = function _executeMethod(){
    var _this = this,
        ...
        vapAccounts = _this.constructor._vapAccounts || _this._vapAccounts;
        ...
        switch (args.type) {
            ...
            case 'send':
                ...
                var sendTransaction = (new Method({
                    ...
                    requestManager: _this._parent._requestManager,
                    accounts: _this.constructor._vapAccounts || _this._vapAccounts, // is vap.accounts (necessary for wallet signing)
                    defaultAccount: _this._parent.defaultAccount,
                    defaultBlock: _this._parent.defaultBlock,
